...
class DecisionTree {
    ...
    private void queryBinTree(BinTree currentNode) throws IOException {
        ...
        if (currentNode.yesBranch==null) {
            ...
            else System.out.println("Error: Missing \"Yes\" branch at \"" + currentNode.questOrAns + "\" question");
            return;
            }
        if (currentNode.noBranch==null) {
    ...
    private void outputBinTree(String tag, BinTree currentNode) {
        ...
        System.out.println("[" + tag + "] nodeID = " + currentNode.nodeID + ", question/answer = " + currentNode.questOrAns);
